...
function ArgMax(res){
    ...
    console.log(cls_data, argMax(cls_data, argMax(cls_data));
...
async function classify (data){
    ...
    try{
        ...
        const path = 'https://raw.githubusercontent.com/fahmi222/jst-learn/main/public/cls_model/cls_model.json';
